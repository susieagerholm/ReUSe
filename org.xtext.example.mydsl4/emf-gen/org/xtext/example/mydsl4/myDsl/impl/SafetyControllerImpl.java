 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.SafetyControllerImpl#getK_velocity <em>Kvelocity</em>}</li>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.SafetyControllerImpl#getK_position <em>Kposition</em>}</li>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.SafetyControllerImpl#getSoftLowerLimit <em>Soft Lower Limit</em>}</li>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.SafetyControllerImpl#getSoftUpperLimit <em>Soft Upper Limit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SafetyControllerImpl extends ReUseAbleImpl implements SafetyController {
	...
	protected EClass eStaticClass() {
		return MyDslPackage.Literals.SAFETY_CONTROLLER;
	}
	...
	public NotificationChain basicSetK_velocity(URDFAttrSignedNumeric newK_velocity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__KVELOCITY, oldK_velocity, newK_velocity);
	...
	public void setK_velocity(URDFAttrSignedNumeric newK_velocity) {
		if (newK_velocity != k_velocity) {
			...
			if (k_velocity != null)
				msgs = ((InternalEObject)k_velocity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__KVELOCITY, null, msgs);
			if (newK_velocity != null)
				msgs = ((InternalEObject)newK_velocity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__KVELOCITY, null, msgs);
			msgs = basicSetK_velocity(newK_velocity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__KVELOCITY, newK_velocity, newK_velocity));
	}
	...
	public NotificationChain basicSetK_position(URDFAttrSignedNumeric newK_position, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__KPOSITION, oldK_position, newK_position);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setK_position(URDFAttrSignedNumeric newK_position) {
		if (newK_position != k_position) {
			NotificationChain msgs = null;
			if (k_position != null)
				msgs = ((InternalEObject)k_position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__KPOSITION, null, msgs);
			if (newK_position != null)
				msgs = ((InternalEObject)newK_position).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__KPOSITION, null, msgs);
			msgs = basicSetK_position(newK_position, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__KPOSITION, newK_position, newK_position));
	}
	...
	public NotificationChain basicSetSoftLowerLimit(URDFAttrSignedNumeric newSoftLowerLimit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT, oldSoftLowerLimit, newSoftLowerLimit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSoftLowerLimit(URDFAttrSignedNumeric newSoftLowerLimit) {
		if (newSoftLowerLimit != softLowerLimit) {
			...
			if (softLowerLimit != null)
				msgs = ((InternalEObject)softLowerLimit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT, null, msgs);
			if (newSoftLowerLimit != null)
				msgs = ((InternalEObject)newSoftLowerLimit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT, null, msgs);
			msgs = basicSetSoftLowerLimit(newSoftLowerLimit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT, newSoftLowerLimit, newSoftLowerLimit));
	}
	...
	public NotificationChain basicSetSoftUpperLimit(URDFAttrSignedNumeric newSoftUpperLimit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT, oldSoftUpperLimit, newSoftUpperLimit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSoftUpperLimit(URDFAttrSignedNumeric newSoftUpperLimit) {
		if (newSoftUpperLimit != softUpperLimit) {
			...
			if (softUpperLimit != null)
				msgs = ((InternalEObject)softUpperLimit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT, null, msgs);
			if (newSoftUpperLimit != null)
				msgs = ((InternalEObject)newSoftUpperLimit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT, null, msgs);
			msgs = basicSetSoftUpperLimit(newSoftUpperLimit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT, newSoftUpperLimit, newSoftUpperLimit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MyDslPackage.SAFETY_CONTROLLER__KVELOCITY:
				return basicSetK_velocity(null, msgs);
			case MyDslPackage.SAFETY_CONTROLLER__KPOSITION:
				return basicSetK_position(null, msgs);
			case MyDslPackage.SAFETY_CONTROLLER__SOFT_LOWER_LIMIT:
				return basicSetSoftLowerLimit(null, msgs);
			case MyDslPackage.SAFETY_CONTROLLER__SOFT_UPPER_LIMIT:
