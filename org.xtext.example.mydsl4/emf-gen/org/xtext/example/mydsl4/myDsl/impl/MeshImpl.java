 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.MeshImpl#getPathToFile <em>Path To File</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeshImpl extends GeometryImpl implements Mesh {
	...
	protected EClass eStaticClass() {
		return MyDslPackage.Literals.MESH;
	}
	...
	public NotificationChain basicSetPathToFile(URDFAttrSTRING newPathToFile, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.MESH__PATH_TO_FILE, oldPathToFile, newPathToFile);
	...
	public void setPathToFile(URDFAttrSTRING newPathToFile) {
		if (newPathToFile != pathToFile) {
			...
			if (pathToFile != null)
				msgs = ((InternalEObject)pathToFile).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MESH__PATH_TO_FILE, null, msgs);
			if (newPathToFile != null)
				msgs = ((InternalEObject)newPathToFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MESH__PATH_TO_FILE, null, msgs);
			msgs = basicSetPathToFile(newPathToFile, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MESH__PATH_TO_FILE, newPathToFile, newPathToFile));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MyDslPackage.MESH__PATH_TO_FILE:
