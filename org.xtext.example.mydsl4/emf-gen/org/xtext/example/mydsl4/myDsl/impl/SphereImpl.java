 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.SphereImpl#getRadius <em>Radius</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SphereImpl extends GeometryImpl implements Sphere {
	...
	protected EClass eStaticClass() {
		return MyDslPackage.Literals.SPHERE;
	}
	...
	public NotificationChain basicSetRadius(URDFAttrNumeric newRadius, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.SPHERE__RADIUS, oldRadius, newRadius);
	...
	public void setRadius(URDFAttrNumeric newRadius) {
		if (newRadius != radius) {
			...
			if (radius != null)
				msgs = ((InternalEObject)radius).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SPHERE__RADIUS, null, msgs);
			if (newRadius != null)
				msgs = ((InternalEObject)newRadius).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SPHERE__RADIUS, null, msgs);
			msgs = basicSetRadius(newRadius, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SPHERE__RADIUS, newRadius, newRadius));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MyDslPackage.SPHERE__RADIUS:
